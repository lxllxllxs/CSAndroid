...
//                String firstCookie=headers.substring(0,headers.indexOf(";"));
    ...
    private static void login(String cookie, String lastCookie, final String validate, final String login, final String pwd){
        Map<String,String> headers= new HashMap<>();
        Map<String, String> params = new HashMap<>();
 ...
 * 获取课表
 */
    public static void getCourseMap(String lastCookie) throws TimeoutException,IOException {
        Map<String,String> headers= new HashMap<>();
